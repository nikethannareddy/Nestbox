  ...
  return (
    <div className="space-y-8">
      <div className="text-center">
        <h1 className="font-serif text-4xl font-bold text-emerald-900 mb-3">Volunteer Dashboard</h1>
        <p className="text-lg text-emerald-700 max-w-2xl mx-auto">
          Thank you for helping protect our local bird community. Your observations and maintenance work make a real
          difference.
        </p>
      </div>
